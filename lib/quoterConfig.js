...
export const PROJECT_TYPES = [
  ...
  {
    id: "bot",
    label: "Agente de IA para tu Negocio",
    price: 500,
    icon: "🤖",
    description:
      "Agente virtual inteligente que atiende a tus clientes las 24 horas por WhatsApp y otros canales. Puede calificar leads, responder preguntas frecuentes, presentar tu catálogo de productos y agendar citas — sin intervención humana.",
