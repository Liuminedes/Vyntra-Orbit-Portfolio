    ...
    work: {
      ...
      projects: [
        ...
        },
        {
          ...
          title: "Fitness Nutrition Store",
          description:
            "E-commerce platform for a fitness nutrition brand. Product catalog, WhatsApp checkout flow, and custom order management.",
  ...
  es: {
    ...
    services: {
      items: [
        ...
        },
        {
          ...
          description:
            "Soporte continuo con performance, seguridad, backups y monitoreo. Respuesta ágil a incidentes y mejoras constantes.",
        },
      ],
    },
    resume: {
    ...
    work: {
      ...
      projects: [
        ...
        {
          num: "04",
          category: "Tienda Fitness",
          title: "Tienda Nutrición Fitness",
          description:
            "E-commerce para una marca de nutrición deportiva. Catálogo de productos, flujo de compra por WhatsApp y gestión de pedidos personalizada.",
          stack: ["WordPress", "WooCommerce", "Elementor"],
          image: "/assets/work/fitness.png",
          live: "",
          github: "",
