export const translations = {
  ...
  es: {
    ...
    home: {
      ...
      greeting: "¡Hola! Somos",
      name: "Vyntra Orbit",
      bio: "Nos destacamos en la creación de experiencias digitales elegantes y construimos productos full-stack que escalan. Desde plataformas SaaS hasta sistemas de automatización — entrega rápida, código limpio.",
