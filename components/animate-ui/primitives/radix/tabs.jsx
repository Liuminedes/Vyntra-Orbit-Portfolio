  ...
  return (
    <AnimatePresence mode="wait">
      <TabsPrimitive.Content
        ...
        value={value}
        render={<motion.div data-slot="tabs-content" layout layoutDependency={value} initial={{ opacity: 0, filter: 'blur(4px)' }} animate={{ opacity: 1, filter: 'blur(0px)' }} exit={{ opacity: 0, filter: 'blur(4px)' }} transition={transition} {...props} />}
      >
        {children}
      </TabsPrimitive.Content>
    </AnimatePresence>
