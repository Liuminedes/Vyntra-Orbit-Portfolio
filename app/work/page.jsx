...
/* ── Skeleton mientras carga el demo ── */
const DemoSkeleton = () => (
  <div style={{
    height: 420,
...
/* ── Lazy load — cada demo recibe `lang` como prop ── */
...
/* ── Mapa de demos: función para que react re-renderice con el lang correcto ── */
const getDemos = (lang) => ({
...
export default function Work() {
  ...
  /* Se reconstruye cada vez que cambia lang o active */
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        pointerEvents: "none",
        background: "radial-gradient(circle at 80% 20%, rgba(108,99,255,0.05) 0%, transparent 70%)",
      }} />
      ...
      <div className="vo-container" style={{ position: "relative", zIndex: 2 }}>
        ...
        <div
          ...
          style={{ animationFillMode: "forwards", marginBottom: "clamp(24px,3vw,40px)" }}
        >
        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              animate="show"
              exit="exit"
              style={{ display: "flex", flexDirection: "column", gap: "clamp(14px,1.5vw,22px)" }}
            >
              {/* Número grande */}
              ...
              {/* Descripción */}
              <p className="vo-body" style={{ maxWidth: "clamp(280px,22vw,360px)", lineHeight: 1.8 }}>
                {project.description}
              </p>
              ...
              <div style={{ display: "flex", gap: 20, paddingTop: 4 }}>
                {project.live && (
                  <a
                    ...
                    style={{
                      ...
                      fontSize: "clamp(10px,0.7vw,12px)", color: "#6C63FF",
                ...
                {project.github && (
                  <a
                    ...
                    style={{
                      display: "inline-flex", alignItems: "center", gap: 5,
                      fontSize: "clamp(10px,0.7vw,12px)", color: "rgba(255,255,255,0.35)",
                      textDecoration: "none", letterSpacing: "0.1em",
                      textTransform: "uppercase", fontFamily: "'DM Mono',monospace",
                      transition: "color 0.2s",
                    }}
